...
public class VehiculoDeCarrera
{
    ...
    private Competencia<VehiculoDeCarrera>.ETipoCompetencia tipo;

    public VehiculoDeCarrera(string escuderia, short numero, Competencia<VehiculoDeCarrera>.ETipoCompetencia tipo)
    {
    ...
    public Competencia<VehiculoDeCarrera>.ETipoCompetencia Tipo => tipo;
